...
<body>
  ...
  <div class="mobile-drawer" id="mobileDrawer">
    ...
    <nav class="drawer-menu">
      <a href="/#about"><img src="{{ asset('css/svg/enaboute1.svg') }}" alt="ՄԵՐ ՄԱՍԻՆ" /></a>
      <a href="/#services"><img src="{{ asset('css/svg/enservices1.svg') }}" alt="ԾԱՌԱՅՈՒԹՅՈՒՆՆԵՐ" /></a>
      <a href="/#job"><img src="{{ asset('css/svg/enfli.svg') }}" alt="ԱՇԽԱՏԱՆՔՆԵՐ" /></a>
      <a href="/#products"><img src="{{ asset('css/svg/enjobs.svg') }}" alt="Ապրանքներ" /></a>
      <a href="/#kap"><img src="{{ asset('css/svg/enkap1.svg') }}" alt="ԿԱՊ" /></a>
          ...
          <div class="job-detail-card">
            ...
            <div class="job-right">
              <h3 class="breakable-title">
                <a style="text-decoration: none; color: #cdd9e1;" href="{{ route('jobs.en', $item->id) }}"
                  style="color: #D9EAF2;">
                  {{ $item->title }}
                </a>
              </h3>
