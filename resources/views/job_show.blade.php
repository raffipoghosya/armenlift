...
<head>
  ...
  <style>
    ...
    .jobs-section, .contact-section {
      padding: 160px 10%; /* Default padding for larger screens */
    }
    ...
    .jobs-title-line, .contact-title-line {
      height: 2px;
      width: 100%;
      max-width: 500px;
      margin-bottom: 40px;
    ...
    .job-detail-card {
      ...
      padding: 30px;
      border-radius: 12px;
      color: white; /* Ensure text color is set for consistency */
      font-family: 'Montserrat Armenian', sans-serif; /* Ensure font is set for consistency */
    }
    ...
    .thumbnail-row {
      display: flex;
      gap: 8px; /* Adjusted from 8px to 10px for consistency if desired, keeping original for now */
      flex-wrap: wrap;
      justify-content: center; /* Center thumbnails */
    }

    .thumbnail-row img {
      width: 80px; /* Overwritten by your new code */
      height: 60px; /* Overwritten by your new code */
      border-radius: 6px;
      object-fit: cover;
      cursor: pointer;
    ...
    .job-right h3 {
      font-family: 'Montserrat Armenian bold';
      font-size: 32px;
      margin-bottom: 16px; /* Adjusted from 10px to 16px to match original */
      position: relative;
      padding-bottom: 18px; /* Added for the line */
    }
    ...
    .job-location { /* This class was defined but not used in HTML, keeping for reference */
      font-size: 16px;
      color: #a7c9dd;
      margin-bottom: 20px;
    }
    ...
    .custom-pagination {
      display: flex;
      list-style: none;
      gap: 32px; /* Adjusted from 10px to 32px based on your new code */
      padding: 0;
      margin: 0;
      font-family: 'Montserrat Armenian', sans-serif;
      font-size: 28px; /* Adjusted from 18px to 28px based on your new code */
      align-items: center;
    }
    ...
    .custom-pagination li.active span {
      ...
      width: 58px; /* Adjusted from 33px to 58px based on your new code */
      height: 58px; /* Adjusted from 33px to 58px based on your new code */
      line-height: 58px; /* Adjusted from 33px to 58px based on your new code */
      text-align: center;
      border-radius: 50%;
    ...
    .scroll-wrapper {
      ...
      margin-left: 15px; /* Added based on .jobs-gallery margin-left */
    }
    ...
    .jobs-gallery {
      ...
      /* Note: .jobs-gallery is now directly a grid, its styling will apply */
      /* min-width: 100%; removed this, it conflicts with grid-auto-columns */
      /* margin-left: 15px; */ /* Moved to scroll-wrapper to apply to container */
    }
    ...
    .job-item {
      ...
      padding: 3px;
      color: white;
      width: 250px; /* Width of each job item */
      height: 274px; /* Height of each job item */
      box-sizing: border-box;
    }

    .job-item img {
      width: 250px; /* Image fills the job-item width */
      height: 274px; /* Image fills the job-item height */
      object-fit: cover;
      border-radius: 6px;
    }
    ...
    /* --- Mobile Menu Specific Styles (Existing and adjusted) --- */
    .mobile-menu-toggle {
    ...
    @media (max-width: 1024px) {
      .jobs-section, .contact-section {
        padding: 120px 5%; /* Reduce padding on smaller screens */
      }
      ...
      .job-right h3::after {
        left: 50%; /* Center the line under the title */
      ...
      /* Jobs Gallery adjustments */
      .jobs-gallery {
        grid-auto-columns: 200px; /* Slightly smaller items for tablets */
        grid-template-rows: repeat(auto-fit, 320px); /* Adjust row height for stacked content */
        justify-content: start; /* Align items to the start in the grid */
        margin-left: 0; /* Remove left margin to fit better */
      }
      ...
      .job-item img {
        width: 100%;
        height: 200px; /* Fixed height for image within item */
      }

      .scroll-wrapper {
        margin-left: 0; /* Remove margin to fit better */
      }
      ...
      .contact-info, .contact-form {
        ...
        max-width: 600px; /* Limit overall width for forms */
      }
      ...
      .contact-form button {
        align-self: center; /* Center the button when form is stacked */
      }
    }
    ...
    @media (max-width: 768px) {
      .jobs-section h2, .contact-section h2 {
        font-size: 38px; /* Further reduce font size */
      }

      .jobs-section, .contact-section {
        padding: 80px 4%; /* More reduced padding for mobile */
      }

      .job-left .main-image {
        max-width: 300px; /* Even smaller max-width for image */
      }

      .job-right h3 {
        font-size: 28px; /* Smaller title font size */
        padding-bottom: 12px; /* Adjust padding for smaller title */
      }

      .job-right h3::after {
        max-width: 250px; /* Shorter line for smaller titles */
      }

      .job-description {
        font-size: 14px; /* Slightly smaller description font */
      }

      .pagination-nav {
        margin-top: 30px; /* Adjust pagination margin */
      }

      .custom-pagination {
        gap: 20px; /* Reduce gap between pagination numbers */
        font-size: 24px; /* Smaller font for pagination numbers */
      }

      .custom-pagination li.active span {
        width: 48px; /* Smaller active page circle */
        height: 48px;
        line-height: 48px;
      }

      /* Jobs Gallery adjustments for smaller mobiles */
      .jobs-gallery {
        grid-auto-columns: 180px; /* Further smaller items */
        grid-template-rows: repeat(auto-fit, 280px); /* Adjust row height */
      }
      ...
      .job-item img {
        height: 180px; /* Fixed height for image within item */
      }

      .job-item h3 {
        font-size: 15px; /* Smaller title in job items */
      }

      .job-address {
        font-size: 13px; /* Smaller address font in job items */
      }
    }
    ...
    @media (max-width: 480px) {
      .jobs-section h2, .contact-section h2 {
        font-size: 30px; /* Smallest font size for titles */
      }

      .jobs-section, .contact-section {
        padding: 60px 3%; /* Minimal padding on very small screens */
      }
      ...
      .job-left .main-image {
        width: 100%;
        max-width: none; /* Allow image to fill width completely if needed */
        height: 250px; /* Fixed height for consistency on small screens */
      }
      ...
      .job-right h3::after {
        max-width: 180px; /* Even shorter line */
      }

      .job-address {
        font-size: 13px; /* Smaller address font */
      }

      .custom-pagination li {
        font-size: 16px; /* Smaller pagination font */
      }

      .custom-pagination li.active span {
        width: 28px; /* Smaller active page circle */
        height: 28px;
        line-height: 28px;
      }

      /* Jobs Gallery adjustments for very small mobiles */
      .jobs-gallery {
        grid-auto-columns: 150px; /* Smallest items */
        grid-template-rows: repeat(auto-fit, 240px); /* Adjust row height */
      }
      ...
      .job-item img {
        height: 150px; /* Fixed height for image within item */
      }

      .job-item h3 {
        font-size: 14px; /* Even smaller title in job items */
      }

      .job-address {
        font-size: 12px; /* Even smaller address font in job items */
      }

      .contact-info ul li {
        font-size: 14px; /* Smaller contact info text */
      }
    ...
    @media (max-width: 980px) { /* This is where your mobile menu kicks in */
        .desktop-menu,
        .desktop-languages {
...
<header class="top-bar">
    ...
    <nav class="menu desktop-menu desktop-only">
        ...
        <a href="/#products"> <img src="{{ asset('css/svg/jobs11.svg') }}" width="160" height="50" alt="Ապրանքներ" />
        </a>
        <a href="/#kap">
    ...
    <div class="languages desktop-languages desktop-only">
        ...
        <a href="{{ route('homepage.ru') }}"><button>РУՍ</button></a>
...
<div class="mobile-drawer" id="mobileDrawer">
    ...
    <nav class="drawer-menu">
        ...
        <a href="/#job"><img src="{{ asset('css/svg/lalala.svg') }}" alt="ԱՇԽԱՏԱՆՔՆԵՐ" /></a>
        <a href="/#products"><img src="{{ asset('css/svg/jobs11.svg') }}" alt="Ապրանքներ" /></a> <a href="/#kap"><img src="{{ asset('css/svg/kap1.svg') }}" alt="ԿԱՊ" /></a>
            ...
            <div class="jobs-gallery">
                @foreach ($otherJobs as $item)
                    <div class="job-item">
                        ...
                        <h3>
                            <a style="text-decoration: none; color: #cdd9e1;" href="{{ route('jobs.hy', $item->id) }}">
                                {{ $item->title }}
                            </a>
                        </h3>
                        @if ($item->address)
...
// Mobile menu toggle script (copied from previous solution)
function toggleMenu() {
