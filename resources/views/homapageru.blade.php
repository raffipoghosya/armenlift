...
<body>
    <div class="background" id="backgroundSlider">
        ...
        <header class="top-bar">
            ...
            <nav class="menu desktop-menu desktop-only">
                <a href="#about"><img src="{{ asset('css/svg/rusaboute.svg') }}" width="164" height="50" alt="О НАС" /></a>
                <a href="#services"><img src="{{ asset('css/svg/russervices1.svg') }}" width="214" height="50" alt="УСЛУГИ" /></a>
                <a href="#job"><img src="{{ asset('css/svg/rusjobs.svg') }}" width="160" height="50" alt="ПОРТФОЛИО" /></a>
                <a href="#products"><img src="{{ asset('css/svg/rusjob1.svg') }}" width="164" height="50" alt="ПРОДУКЦИЯ" /></a>
                <a href="#kap"><img src="{{ asset('css/svg/ruskap1.svg') }}" width="152" height="50" alt="КОНТАКТЫ" /></a>
            </nav>
        ...
        <section id="about" class="about-section">
            <div class="about-text">
                ...
                <div class="about-license">
                    <img src="{{ asset('css/svg/rusli.svg') }}" alt="Лицензия" onclick="openModal()" style="cursor: pointer;" />
                </div>
    ...
    @if($ruJobs->count())
        <section id="job" class="jobs-section">
            ...
            <div class="job-filter-buttons">
                <img src="{{ asset('css/svg/luluru.svg') }}" alt="Общественные" class="job-filter-svg" onclick="filterJobs('public')" />
                <img src="{{ asset('css/svg/luluru1.svg') }}" alt="Жилые" class="job-filter-svg" onclick="filterJobs('residential')" />
            </div>
                            ...
                            @if (is_array($product->pdf) && count($product->pdf))
                                <div class="pdf-button-group">
                                    @foreach ($product->pdf as $pdf)
                                        <a href="{{ asset('storage/' . $pdf['file']) }}" target="_blank" class="pdf-button">📄 {{ $pdf['name'] ?? 'PDF файл' }}</a>
                                    @endforeach
                                </div>
                            @endif
                        </div>
    ...
    <section id="kap" class="contact-section">
        ...
        <div class="contact-container">
            <div class="contact-info">
                <ul>
                    <li><img src="/css/svg/location.svg" alt="Адрес" width="16" height="16" style="margin-right: 11px;"> Адрес: 0076, Армения, г. Ереван, Аксел Бакунц 4</li>
                    <li><img src="/css/svg/telefon.svg" alt="Телефон" width="16" height="16" style="margin-right: 11px;"> Тел.: +37491430512</li>
                    <li><img src="/css/svg/gmail.svg" alt="Эл. почта" width="16" height="16" style="margin-right: 11px;"> Эл. почта: armenlift@gmail.com</li>
                </ul>
    ...
    <div id="imageModal" class="modal-overlay" onclick="closeModal()">
        <div class="modal-content" onclick="event.stopPropagation();">
            <img src="{{ asset('css/images/modal.png') }}" alt="Изображение лицензии" />
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (slider) {
                ...
                const getCurrentImageArray = () => window.innerWidth < 900 ? mobileImages : desktopImages;
            ...
            window.filterJobs = (type) => {
                ...
                buttons.forEach(btn => {
                    ...
                    if ((type === 'public' && alt.includes('Общественные')) || (type === 'residential' && alt.includes('Жилые'))) {
